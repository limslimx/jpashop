...
import com.lim.jpashop.springboot.domain.Address;
...
public class OrderServiceTest {
    ...
    public void 주문취소() throws Exception{
        ...
        assertEquals("주문취소시 상태는 CANCEL", OrderStatus.CANCEL, order.getStatus());
        assertEquals("주문취소시 상품 수량이 복구되어야 한다.", 10, book.getStockQuantity());
    }
